package com.vsoontech.game.geniussch.font;
...
import com.vsoontech.game.geniussch.font.writer.BitmapFontWriter;
...
public class SmartFontGenerator {
     ...
     * Writing a generated font to files allows the possibility of only generating the fonts when they are missing,
     * otherwise
    ...
    private void saveFontToFile(BitmapFont font, int fontSize, String fontName, PixmapPacker packer) {
        ...
        BitmapFontWriter
            .writeFont(font.getData(), pageRefs, fontFile, new BitmapFontWriter.FontInfo(fontName, fontSize), 1, 1);
    }
