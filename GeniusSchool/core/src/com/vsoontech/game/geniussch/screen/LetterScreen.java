...
public class LetterScreen extends GsScreen {
    ...
    private void nextWord() {
        ...
        createLetterActors(letters, blankFields, fillFields, dAtlasFields, aTouchFields);
    ...
    private void createLetterActors(char[] letters, String[] blankFields, String[] fillFields, String[] dAtlasFields,
        ...
        if (blankFields != null && blankFields.length > 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                // 音效
                Music music = mGame.assetManager.get(mGame.resFields.get(aTouchFields[i]));
                tFlActor.setAudio(music);
            ...
            if (mBlankActors.length > 0) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    fillActor.setPosition(leftStart, (int) (heightStart + fillActor.getHeight() / 2 + 60));
    ...
    private InputListener mInputListener = new InputListener() {
        ...
        public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
            ...
            if (allowLog()) {
                doLog("LetterScreen ClickListener ! " + actor);
            }
        ...
        public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
            ...
            if (actor instanceof LetterFillActor) {
                ((LetterFillActor) actor).stopAnimation();
            }
        }
