...
//                        getResources().getDrawable(R.mipmap.ic_me), Color.WHITE
//                ).build()
//        );
//        models1.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), Color.LTGRAY
//                ).build()
//        );
//        models1.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), Color.GRAY
//                ).build()
//        );
//        models1.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), Color.DKGRAY
//                ).build()
//        );
...
//        models2.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), Color.YELLOW
//                ).build()
//        );
//        models2.add(
//                new NavigationTabBar.Model.Builder(
...
//        models3.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), Color.RED
//                ).build()
//        );
//        models3.add(
//                new NavigationTabBar.Model.Builder(
...
//        models4.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), bgColor
//                ).build()
//        );
//        models4.add(
//                new NavigationTabBar.Model.Builder(
...
//        models6.add(
//                new NavigationTabBar.Model.Builder(
//                        getResources().getDrawable(R.mipmap.ic_me), randomColor()
//                ).build()
//        );
//        models6.add(
//                new NavigationTabBar.Model.Builder(
