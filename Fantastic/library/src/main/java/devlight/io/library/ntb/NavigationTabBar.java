...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected boolean mViewPagerSmoothScroll;
    ...
    public void setViewPager(final ViewPager viewPager, int index) {
        ...
        mIndex = index;
        if (mIsViewPagerMode) mViewPager.setCurrentItem(index, mViewPagerSmoothScroll);
        postInvalidate();
    }
    ...
    public void setModelIndex(final int modelIndex, final boolean isForce) {
        ...
        if (mIsViewPagerMode) {
            ...
            mViewPager.setCurrentItem(index, mViewPagerSmoothScroll);//!force
        }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsPointerActionDown) {
                    if (mIsHorizontalOrientation)
                        mViewPager.setCurrentItem((int) (event.getX() / mModelSize), mViewPagerSmoothScroll);
                    else
                        mViewPager.setCurrentItem((int) (event.getY() / mModelSize), mViewPagerSmoothScroll);
                    break;
                }
