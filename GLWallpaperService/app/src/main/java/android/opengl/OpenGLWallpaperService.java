 ...
 */
public class OpenGLWallpaperService extends WallpaperService {
...
class DefaultWindowSurfaceFactory implements GLSurfaceView.EGLWindowSurfaceFactory {
    ...
    public javax.microedition.khronos.egl.EGLSurface createWindowSurface(EGL10 egl, javax.microedition.khronos.egl.EGLDisplay
            display, javax.microedition.khronos.egl.EGLConfig config, Object nativeWindow) {
...
class GLThread extends Thread {
    ...
    GLThread(GLSurfaceView.Renderer renderer, GLSurfaceView.EGLConfigChooser chooser, GLSurfaceView.EGLContextFactory contextFactory,
        ...
        mHeight = 0;
        mRequestRender = true;
        mRenderMode = OpenGLWallpaperService.GLEngine.RENDERMODE_CONTINUOUSLY;
        mRenderer = renderer;
        this.mEGLConfigChooser = chooser;
        this.mEGLContextFactory = contextFactory;
        this.mEGLWindowSurfaceFactory = surfaceFactory;
                ...
                synchronized (sGLThreadManager) {
                    while (true) {
                        ...
                        if ((!mPaused) && mHasSurface && mHaveEgl && (mWidth > 0) && (mHeight > 0)
                                && (mRequestRender || (mRenderMode == OpenGLWallpaperService.GLEngine.RENDERMODE_CONTINUOUSLY))) {
    ...
    public void setRenderMode(int renderMode) {
        if (!((OpenGLWallpaperService.GLEngine.RENDERMODE_WHEN_DIRTY <= renderMode) && (renderMode <= OpenGLWallpaperService.GLEngine.RENDERMODE_CONTINUOUSLY))) {
            throw new IllegalArgumentException("renderMode");
        }
        synchronized (sGLThreadManager) {
            mRenderMode = renderMode;
            if (renderMode == OpenGLWallpaperService.GLEngine.RENDERMODE_CONTINUOUSLY) {
                sGLThreadManager.notifyAll();
            }
        }
    }
...
abstract class BaseConfigChooser implements GLSurfaceView.EGLConfigChooser {
    ...
    abstract javax.microedition.khronos.egl.EGLConfig chooseConfig(EGL10 egl, javax.microedition.khronos.egl.EGLDisplay display, javax.microedition.khronos.egl.EGLConfig[] configs);
    ...
    public static class ComponentSizeChooser extends BaseConfigChooser {
        ...
        public javax.microedition.khronos.egl.EGLConfig chooseConfig(EGL10 egl, javax.microedition.khronos.egl.EGLDisplay display, javax.microedition.khronos.egl.EGLConfig[] configs) {
            javax.microedition.khronos.egl.EGLConfig closestConfig = null;
